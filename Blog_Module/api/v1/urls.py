...
router.register('view_set_post',PostModelViewSet,basename='api_viewset_post')
router.register('view_set_category',CategoryModelViewSet,basename='api_viewset_category')
